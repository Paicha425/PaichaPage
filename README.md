<h1>Paicha</h1>
<p>PDF Accessibility – Interactive Check Assistant</p>

<p>
Paicha is an independent project for developing a user-friendly, cross-plattform PDF accessibility validator.
